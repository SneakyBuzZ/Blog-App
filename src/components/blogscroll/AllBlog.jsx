    ...
    return (
        <div>
            <ul className="flex h-full flex-col">
                {blogs.map((eachItem) => (
                    <div key={eachItem.id} className="bg-gray-100 w-full my-10 md:my-6 items-center justify-center flex flex-col md:flex-row p-5 md:p-7 rounded-lg md:rounded-xl">
                        ...
                        <div className="md:w-7/12 md:p-4 w-full md:px-10">
                            <div className="titleBlog mt-2 text-xl md:text-[20px] lg:text-[25px] font-serif">{eachItem.title}</div>
