  ...
  return (
    <>
      <section className="text-gray-600 flex flex-col items-center w-full justify-center bg-neutral-100 dark:bg-black">
        <div className="flex flex-col items-center md:flex-row mx-auto md:items-start justify-around w-full px-20 lg:px-60 ">
          <ProfileAvatar />
          ...
          <Button
            ...
            className=" bg-transparent mb-5 md:mt-20"
          >
